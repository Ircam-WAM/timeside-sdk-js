...
export enum ProcessorListPidEnum {
    ...
    VampCrest = 'vamp_crest',
    VampFlatness = 'vamp_flatness',
    VampKurtosis = 'vamp_kurtosis',
    VampSimpleHost = 'vamp_simple_host',
    VampSpectralCentroid = 'vamp_spectral_centroid',
    VampSpectralKurtosis = 'vamp_spectral_kurtosis',
    VampSpectralSlope = 'vamp_spectral_slope',
