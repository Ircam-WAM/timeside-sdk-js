...
export interface InlineResponse2004 {
    ...
    /**
     * 
     * @type {Array<ProcessorList>}
     * @memberof InlineResponse2004
     */
    results?: Array<ProcessorList>;
}
...
export function InlineResponse2004FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse2004 {
    ...
    return {
        ...
        'results': !exists(json, 'results') ? undefined : ((json['results'] as Array<any>).map(ProcessorListFromJSON)),
    };
}
...
export function InlineResponse2004ToJSON(value?: InlineResponse2004 | null): any {
    ...
    return {
        ...
        'results': value.results === undefined ? undefined : ((value.results as Array<any>).map(ProcessorListToJSON)),
    };
}
